export declare const APPLICATION_STATUSES: readonly ["draft", "submitted", "interview", "offer", "rejected", "withdrawn"];
...
export declare const CONFIDENCE_TIER_RANGES: Record<ConfidenceTier, {
    min: number;
    max: number;
}>;
...
export declare const DEEPSEEK_TIMEOUT_MS = 30000;
export declare const DEEPSEEK_DEFAULT_TEMPERATURE = 0.4;
export declare const DEEPSEEK_DEFAULT_MAX_TOKENS = 1800;
export declare const DEEPSEEK_COST_PER_1K: Record<string, {
    prompt: number;
    completion: number;
}>;
